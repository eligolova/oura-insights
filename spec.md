...
This document is written to be used directly as a **Claude Code specification** — designed to be given to Claude as context for building, iterating, and maintaining the app.
...
* Target AI coding tool: **Claude Code (claude.ai/claude-code)**
...
* Natural-language queries over your own data via Claude API (claude-sonnet-4-6)
* Claude-powered narrative summaries: weekly/monthly health reports generated by Claude
* Anomaly explanations: when a metric looks unusual, ask Claude why it might have happened
